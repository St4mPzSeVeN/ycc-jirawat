...
<div class="collapse navbar-collapse justify-content-center" id="more">
  <ul class="navbar-nav">
    ...
    <li class="nav-item active">
      <a class="nav-link" href="#" style="size: 42px;"><b>ZENBOOK</b></a>
    </li>
  </ul>
</div>
</nav>
...
<div class="container-fluid" style="font-family: Unica One; padding-top: 8vh"><center>
	<h1 style="font-size: 7vh;"><b>ZENBOOK PRO</b></h1><br>
	<h5>EXTEND THE IMAGINATION.</h5><br>
</center></div>
<div class="container" style="text-align: center;">
<h1>
	CUSTOMIZE YOUR ZENBOOK PRO
</h1>
<div class="row">
<div class="col-sm-3">
	</div>
<div class="col-sm-6" style="font-family: Kanit; color:grey; text-align: left;">
	2.4GHz Intel Core i9-9980HK (octa-core, 16MB cache, up to 5GHz) <br>32GB DDR4 RAM <br>Nvidia GeForce RTX 2060 <br>15.6-inch, OLED Ultra HD, 14-inch Ultra HD touch display <br>1 x Thunderbolt 3 <br>2 x USB-C 3.1 <br>HDMI 2.0 <br>headset jack <br>Intel Wi-Fi 6 with Gig+ performance <br>IR webcam with Windows Hello support
</div>
<div class="col-sm-3">
	</div>
</div>
